...
namespace FourChambers
{
    class Cow : EnemyActor
    {
            ...
            : base(xPos, yPos)
        {
            ...
            //drag.X = runSpeed * 4;
            //drag.Y = runSpeed * 4;
            playbackFile = "FourChambers/ActorRecording/cow.txt";
            ...
            loadGraphic(FlxG.Content.Load<Texture2D>("fourchambers/characterSpriteSheets/Cow_20x20"), true, false, 20, 20);
