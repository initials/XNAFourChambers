...
{
    class Lion : EnemyActor
    {
        public Lion(int xPos, int yPos)
            : base(xPos, yPos)
        {
            ...
            //drag.X = runSpeed * 4;
            //drag.Y = runSpeed * 4;
            playbackFile = "FourChambers/ActorRecording/lion.txt";
            ...
            loadGraphic(FlxG.Content.Load<Texture2D>("fourchambers/characterSpriteSheets/Lion_20x20"), true, false, 20, 20);
